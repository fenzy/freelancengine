...
class ET_FreelanceEngine extends AE_Base {
	...
	function on_add_scripts() {
		...
		*/
		...
		// geocoder js
		$this->add_script( 'geocode', get_template_directory_uri() . '/assets/js/address-geocoder.js', array(
			'jquery',
			'underscore',
			'backbone',
			'appengine',
	...
	function on_add_styles() {
		...
		// jquery file upload
		$this->add_style( 'fileupload', get_template_directory_uri() . '/css/jquery.fileupload.css', ET_VERSION );
