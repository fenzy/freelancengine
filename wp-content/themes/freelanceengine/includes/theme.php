 ...
 * @author YuMing
 */
add_action( 'wp_ajax_upload_project_files', 'fre_upload_project_files' );
function fre_upload_project_files() {
	$res = array(
		'success' => false,
	);
    ...
    move_uploaded_file( $_FILES['files']['tmp_name'], $wp_upload_dir['path']  . '/' . $filename );
