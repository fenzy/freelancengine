        ...
        <form class="post" role="form">
            <div class="step-post-project" id="fre-post-project">
                ...
                <div class="fre-input-field">
                    <label class="fre-field-title" for="project_category"><?php _e('WHAT ENGINEERING BRANCH DO YOU REQUIRE?', ET_DOMAIN);?></label>
                    <?php
                        $cate_arr = array();
                        ...
                        ae_tax_dropdown( 'project_category' ,
                          array(  'attr' => 'data-chosen-width="100%" data-chosen-disable-search="" multiple data-placeholder="'.sprintf(__("Choose maximum %s categories", ET_DOMAIN), ae_get_option('max_cat', 3)).'"',
                                  'class' => 'fre-chosen-category hidden',
                        ...
                        ae_project_category_list( 'project_category' );
                ...
                <div>
                    <label class="fre-field-title" for="fre-job-location"><?php _e('Job Location', ET_DOMAIN);?></label>
                </div>

                <!--
                <div id="geocodepreview" style="height: 240px; position: relative; overflow: hidden; margin: 20px;"></div>
                -->
                <input class="input-item text-field hidden" id="job_latlng" type="text" name="job_latlng" />

                <div class="fre-input-field">
                    <div class="col-lg-2">
                        <label class="fre-field-title" for="fre-address" style="padding-top: 12px;">ADDRESSS:</label>
                    </div>
                    <div class="col-lg-10">
                        <input class="input-item text-field" id="fre-address" type="text" name="job_address" required />
                    </div>
                </div>

                <div class="fre-input-field">
                    <div class="col-lg-2">
                        <label class="fre-field-title" for="fre-city" style="padding-top: 12px;">CITY*:</label>
                    </div>
                    <div class="col-lg-10">
                        <input class="input-item text-field" id="fre-city" type="text" name="job_city" required />
                    </div>
                </div>

                <div class="fre-input-field">
                    <div class="col-lg-2">
                        <label class="fre-field-title" for="fre-state" style="padding-top: 12px;">STATE*:</label>
                    </div>
                    <div class="col-lg-10">
                        <input class="input-item text-field" id="fre-state" type="text" name="job_state" required />
                    </div>
                </div>

                <div class="fre-input-field">
                    <div class="col-lg-2" style="padding-top: 12px;">
                        <label class="fre-field-title" for="fre-zipcode" style="padding-top: 12px;">ZIPCODE*:</label>
                    </div>
                    <div class="col-lg-10">
                        <input class="input-item text-field" id="fre-zipcode" type="text" name="job_zipcode" required />
                    </div>
                </div>

                <div class="fre-input-field">
                    <div>
                        <label class="fre-field-title" for="fre-job-result"><?php _e('SELECT IF APPLIES: DESCRIBE WHAT TYPE OF FILE(S) YOU NEED BACK*', ET_DOMAIN);?></label>
                    </div>

                    <div class="file_type col-lg-12">
                        <input type="radio" name="job_result" value="CAD">CAD</input>
                    </div>
                    <div class="file_type col-lg-12"">
                        <input type="radio" name="job_result" value="PDF">PDF</input>
                    </div>
                    <div class="file_type col-lg-12"">
                        <input type="radio" name="job_result" value="DRAWINGS">SHOP DRAWINGS</input>
                    </div>
                    <div class="file_type">
                        <div class="col-lg-2">
                            <input type="radio" name="job_result" value="OTHER" for="job_other_result">OTHER</input>
                        </div>
                        <div class="col-lg-10">
                            <input class="input-item text-field" id="job_other_result" type="text" name="job_other_result" />
                        </div>
                    </div>
                </div>
                ...
                <div class="fre-post-project-btn">
                    <button class="fre-btn fre-post-project-next-btn primary-bg-color" id="project_submit" type="submit"><?php _e("Submit Project", ET_DOMAIN); ?></button>
                </div>
            </div>
        </form>
    </div>
