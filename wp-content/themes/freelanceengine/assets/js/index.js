...
( function( $ ) {
    $("#project_category option").each(function(){
        var category_id = $(this).attr('value');

        if ($(this).prop("selected") && (category_id != "")) {
            $('.category_item#' + category_id + ' .fa-check-circle').removeClass('hidden');
        }
    });
    ...
    $('.category_item').on('click', function(){
        ...
        if ($(this).find('.fa-check-circle').hasClass('hidden')) {
            $(this).find('.fa-check-circle').removeClass('hidden');
            $("#project_category option[value='" + category_id + "']").prop("selected", true);
        } else {
            $(this).find('.fa-check-circle').addClass('hidden');
            $("#project_category option[value='" + category_id + "']").prop("selected", false);
        }
    });

    // add milestones
    $('#milestones').append('<option data-index="0" value="Milestone 1: DOCUMENTS CHECKED" selected="">Milestone 1: DOCUMENTS CHECKED</option>');
    $('#milestones').append('<option data-index="1" value="Milestone 2: STARTED DRAWING" selected="">Milestone 2: STARTED DRAWING</option>');
    $('#milestones').append('<option data-index="2" value="Milestone 3: DRAWINGS COMPLETED" selected="">Milestone 3: DRAWINGS COMPLETED</option>');

    $('#milestones_id').append('<option data-index="0" value="0" selected="">0</option>');
    $('#milestones_id').append('<option data-index="1" value="0" selected="">0</option>');
    $('#milestones_id').append('<option data-index="2" value="0" selected="">0</option>');

    $('.submit-project-list-milestone').append('<li class="milestone-item-wrapper ui-sortable-handle"><span class="arrow-milestone-item"><i class="fa fa-arrows-v"></i></span><input type="text" data-index="0" class="txt-milestone-item" value="Milestone 1: DOCUMENTS CHECKED"><a class="btn-del-milestone-item" href=""><i class="fa fa-remove"></i></a></li>');
    $('.submit-project-list-milestone').append('<li class="milestone-item-wrapper ui-sortable-handle"><span class="arrow-milestone-item"><i class="fa fa-arrows-v"></i></span><input type="text" data-index="1" class="txt-milestone-item" value="Milestone 2: STARTED DRAWING"><a class="btn-del-milestone-item" href=""><i class="fa fa-remove"></i></a></li>');
    $('.submit-project-list-milestone').append('<li class="milestone-item-wrapper ui-sortable-handle"><span class="arrow-milestone-item"><i class="fa fa-arrows-v"></i></span><input type="text" data-index="2" class="txt-milestone-item" value="Milestone 3: DRAWINGS COMPLETED"><a class="btn-del-milestone-item" href=""><i class="fa fa-remove"></i></a></li>');
